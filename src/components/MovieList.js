...
function MovieList(props) {
  ...
  const newMovies = [
    ...
    },
    {
      ...
      poster:
        "https://s359.kapook.com/pagebuilder/44c62352-5ba7-4bb7-a42c-0f37e652ffa6.jpg",
    },
    {
      id: 5,
      title: "Ditto",
      description: "Description of Movie I",
      poster: "https://asianwiki.com/images/6/61/Ditto_2022-p1.jpg",
    },
    {
      id: 6,
      ...
      description: "Description of Movie I",
      poster:
        "https://upload.wikimedia.org/wikipedia/en/thumb/6/6a/An_Irish_Goodbye_poster.jpg/220px-An_Irish_Goodbye_poster.jpg",
    },
    {
      id: 7,
      title: "THE WHALE",
    ...
    },
    {
      ...
      poster: "https://i.ebayimg.com/images/g/X~MAAOSwIfJiR4-N/s-l1600.jpg",
    },
    {
      id: 9,
      title: "ALL QUIET ON WESTERN FRONT",
      description: "Description of Movie G",
      poster:
  ...
  const oscarAwards = [
    ...
    {
      id: 3,
      title: "All Quiet In Western Front",
      description: "Description of Movie G",
      poster:
        "https://m.media-amazon.com/images/M/MV5BMzM4ZDJhYjYtZGY5Ny00NTk0LWI4ZTYtNjczZDFiMGI2ZjEzXkEyXkFqcGdeQXVyNjc5NjEzNA@@._V1_FMjpg_UX1000_.jpg",
    },
  ...
  const maxMovies = expanded
    ? Math.min(
        listsToShow + listsToAdd,
        Math.ceil(moviesToDisplay.length / moviesPerList)
      )
    : listsToShow;
        ...
        <div className="movie-card-container">
          {moviesToDisplay.slice(0, maxMovies * moviesPerList).map((movie) => (
            <div className="movie-card" key={movie.id}>
              ...
              />
              <div className="title" onClick={() => MovieClicked(movie)}>
                {movie.title}
              </div>
            </div>
          ))}
